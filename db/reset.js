    ...
    return new Promise((resolve, reject) => {
        models.Activity.sync({force:true}).then(()=>{
            models.Activity.bulkCreate([
                {type: 'Loading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Loading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Loading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Loading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Loading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Unloading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Unloading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Unloading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Unloading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1},
                {type: 'Unloading', address_id: faker.random.number(10) + 1, name: faker.commerce.department(), phone: faker.phone.phoneNumber(), contact_person: faker.name.firstName(), remarks: faker.lorem.sentence(), date: new Date(), date_from: new Date(), date_untill: new Date(), time_from: '', time_till: '', sequence: faker.random.number(49), shipment_id: faker.random.number(11) + 1}
